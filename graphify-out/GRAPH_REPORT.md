# Graph Report - ForgeOps  (2026-05-23)

## Corpus Check
- 129 files · ~14,825 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 852 nodes · 1015 edges · 77 communities (56 shown, 21 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `022255e5`
...
3. `scripts` - 17 edges
4. `scripts` - 15 edges
5. `WorkspacesService` - 10 edges
6. `AuthService` - 10 edges
7. `AuthController` - 10 edges
8. `PrismaService` - 9 edges
9. `WorkspacesController` - 9 edges
...
Cohesion: 0.13
Nodes (10): AiModule, AuditModule, CostModule, DeploymentsModule, GeneratorModule, ObservabilityModule, QueuesModule, SecurityModule (+2 more)
...
Cohesion: 0.14
Nodes (14): AI_PROVIDER, AiAnalysisResult, AiAnalyzeInput, AiChatMessage, AiProvider, AiRecommendation, AiRootCause, AiSubject (+6 more)
...
Cohesion: 0.17
Nodes (5): Public(), FeatureFlagsController, FeatureFlagsModule, HealthController, HealthModule
...
Cohesion: 0.18
Nodes (11): AuditEventSummary, AuditQueryInput, auditQuerySchema, AuditAction, FindingKind, Severity, findingKindEnum, SecurityFindingSummary (+3 more)
...
Cohesion: 0.24
Nodes (7): AuditController, JwtPayload, CurrentWorkspace, Roles(), AuthenticatedUser, ForgeOpsRequest, WorkspaceContext
...
Cohesion: 0.11
Nodes (9): AuthController, parseDuration(), AuthModule, AuthService, AuthUser, TokenPair, JwtStrategy, LoginDto (+1 more)

### Community 65 - "Community 65"
Cohesion: 0.15
Nodes (7): CurrentUser, UpdateProfileDto, UsersController, UsersModule, UpdateProfileDto, UserProfile, UsersService

### Community 66 - "Community 66"
Cohesion: 0.19
Nodes (5): WorkspacesModule, CreateWorkspaceDto, InviteMemberDto, UpdateMemberRoleDto, WorkspacesService

### Community 67 - "Community 67"
Cohesion: 0.17
Nodes (11): Architecture, Build roadmap (10 days), code:bash (# 1. Install dependencies), code:block2 (forgeops/), ForgeOps, Getting started, License, Project layout (+3 more)

### Community 68 - "Community 68"
Cohesion: 0.31
Nodes (3): RecordAuditDto, PrismaModule, PrismaService

### Community 70 - "Community 70"
Cohesion: 0.33
Nodes (5): code:block1 (providers/<surface>/), code:ts (constructor(@Inject(ROLLOUT_DRIVER) private readonly driver:), Pattern, Provider registry, Surfaces

### Community 72 - "Community 72"
Cohesion: 0.50
Nodes (3): Env, envSchema, validateEnv()

## Knowledge Gaps
- **461 isolated node(s):** `$schema`, `target`, `module`, `moduleResolution`, `lib` (+456 more)
...
- **Why does `bootstrap()` connect `API Runtime Dependencies` to `Community 71`?**
